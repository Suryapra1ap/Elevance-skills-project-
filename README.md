...
| [**`TASK-1-Adaptive-Multi-Cell-Battery-Intelligence-Engine`**](https://github.com/Suryapra1ap/Elevance-skills-project-/tree/TASK-1-Adaptive-Multi-Cell-Battery-Intelligence-Engine) | **Multi-Cell Telemetry & HMI**<br>Validation of core 4-cell parallel ADC tracking. | 4x Cell Potentiometers, LiquidCrystal I2C Display | Isolated Code, Task Readme, Hardware Schematic, Demo Video |
